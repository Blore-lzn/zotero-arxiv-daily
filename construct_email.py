...
def get_block_html(
    ...
    link = (
        f'<a href="{pdf_url.replace("/pdf/", "/abs/")}" style="display: inline-block; text-decoration: none; font-size: 14px; font-weight: bold; color: #fff; background-color: #41d843; padding: 8px 16px; border-radius: 4px; margin-left: 8px;">Link</a>'
        if pdf_url
        else ""
    )
    block_template = """
